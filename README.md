...
```shell
export ZSH="$HOME/.dotfiles/oh-my-zsh"; sh -c "$(curl -fsSL https://raw.githubusercontent.com/nrjais/oh-my-zsh/master/tools/install.sh)"
```
...
```shell
git clone git://github.com/nrjais/oh-my-zsh.git ~/.oh-my-zsh
```
