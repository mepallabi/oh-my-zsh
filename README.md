...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/mepallabi/oh-my-zsh/master/tools/install.sh)"
```
...
```shell
export ZSH="$HOME/.dotfiles/oh-my-zsh"; sh -c "$(curl -fsSL https://raw.githubusercontent.com/mepallabi/oh-my-zsh/master/tools/install.sh)"
```
...
```shell
git clone git://github.com/mepallabi/oh-my-zsh.git ~/.oh-my-zsh
```
